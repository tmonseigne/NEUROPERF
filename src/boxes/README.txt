...
[Thu Jan 24 15:10:28 2019]
-------------------------

The generator produced the following files:

The Box class:
- ovpCBoxAlgorithmTestBox.h
- ovpCBoxAlgorithmTestBox.cpp
...
You may have to change the file ovpCBoxAlgorithmTestBox.h to make it find the included file ovp_defines.h, whose path is related to the project used.
...
#include "[my-box-folder]/ovpCBoxAlgorithmTestBox.h"
...
OVP_Declare_New(OpenViBEPlugins::Test::CBoxAlgorithmTestBoxDesc);
...
